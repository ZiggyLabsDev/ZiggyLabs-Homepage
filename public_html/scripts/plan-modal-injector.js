(() => {
  ...
  const plans = [
    ...
    {
      id: 'fix-site-plan',
      heading: 'Great, you have selected our Fix Site Plan. Select any Add-ons you want below:',
      basePrice: 0.00,
      intro: 'Tell us what needs fixing and choose any extras that fit your project',
      addons: [
        {
          name: 'AI Chatbot',
          price: 130.00,
    ...
    {
      id: 'not-sure-plan',
      heading: 'Great, you selected Not Sure What Option Is Right for Me. Select any Add-ons you want below:',
      basePrice: 0.00,
      intro: 'Share your goals and we will recommend the right scope and plan for you',
      addons: [
        {
          name: 'AI Chatbot',
          price: 130.00,
      ...
      <div id="${plan.id}-maintenance" class="modal-large maintenance-modal" tabindex="-1" data-plan-id="${plan.id}">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="button button-secondary" data-modal-trigger="website-questionnaire" data-modal-replace="true" data-plan-id="${plan.id}">Skip</button>
    ...
    return `
      <div id="${plan.id}" class="modal-large addon-modal" tabindex="-1">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="button button-secondary" data-modal-trigger="${plan.id}-maintenance" data-modal-replace="true">Skip</button>
